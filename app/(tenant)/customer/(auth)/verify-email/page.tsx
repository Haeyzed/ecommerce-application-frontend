...
function VerifyEmailContent() {
  ...
  // Construct the verifyUrl as expected by the backend for tenant customer
  const verifyUrl = `/api/tenant/customer/email/verify?expires=${expires}&signature=${signature}&email=${email}`

  return (
    <>
      <TenantMetadata pageTitle="Customer Verify Email" />
      <div className="flex min-h-svh items-center justify-center p-6">
